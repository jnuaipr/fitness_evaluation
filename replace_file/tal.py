...
def make_anchors(feats, strides, grid_cell_offset=0.5):
    ...
    for i, stride in enumerate(strides):
        ...
        sx = torch.arange(start=0, end=w, device=device, dtype=dtype) + grid_cell_offset  # shift x
        sy = torch.arange(start=0, end=h, device=device, dtype=dtype) + grid_cell_offset  # shift y
